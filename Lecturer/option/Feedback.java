...
public class Feedback {
   ...
   public Feedback(String name, String lecID, HashMap<String, String> loginInfoOriginal) {
      ...
      backPanel.addMouseListener(new MouseAdapter() {
         ...
         public void mouseClicked(MouseEvent e) {
            frame.dispose();
            new LecturerPage(name, lecID, loginInfoOriginal);
         }
      ...
      try (BufferedReader reader = new BufferedReader(new FileReader("data/booking/accepted/accepted.txt"))) {
         ...
         while ((line = reader.readLine()) != null) {
            ...
            if (data.length >= 7) {
               ...
               if (lecturerID.equals(lecID) && LocalDateTime.now().isAfter(bookingEndTimeLocal)) {
   ...
   private JPanel createFeedbackPanel(String bookingID, String userID, String lecID, String day, String date, String startTime, String endTime) {
      ...
      JLabel studentLabel = new JLabel("<html>Student Name: <span style='color:#636261;'>" + studentName + "</span></html>");
      studentLabel.setFont(new Font("Poppins", Font.BOLD, 17));
   ...
   private void saveFeedback(String bookingID, String studentID, String lecID, String day, String date, String startTime, String endTime, String status, String feedback) {
      try (BufferedWriter writer = new BufferedWriter(new FileWriter("data/feedback/lecFeedback.txt", true))) {
   ...
   private boolean checkFeedbackSubmitted(String bookingID, String lecID) {
      try (BufferedReader reader = new BufferedReader(new FileReader("data/feedback/lecFeedback.txt"))) {
         String line;
         while ((line = reader.readLine()) != null) {
            String[] data = line.split(";");
            if (data.length >= 2 && data[0].equals(bookingID) && data[2].equals(lecID)) {
               return true;
            }
         }
      } catch (IOException e) {
