...
public class LecturerPage implements ActionListener {
   ...
   public LecturerPage(String userID, HashMap<String, String> loginInfoOriginal) {
   ...
   public void actionPerformed(ActionEvent e) {
      if (e.getSource() == logoutButton) {
         frame.dispose();
         new LectureLogin(loginInfoOriginal);
      }
   }
}
